  ...
  if (items.length === 0) {
    return (
      <div className="flex flex-col items-center gap-4 py-10 rounded-lg border border-dashed border-neutral-700 bg-neutral-900/40">
        ...
        <Button size="sm" variant="secondary" onClick={onAdd} leftIcon={<PlusIcon />}>
          {addLabel}
        </Button>
      </div>
    )
  ...
  return (
    ...
    >
      {ordered.map((item, index) => {
        ...
        const isPendingDelete = pendingRemove === item.id
        ...
        return (
          <div
            ...
            className={[
              ...
              isDragging
                ...
                : isPendingDelete
                  ? 'border-danger-500/50 bg-danger-600/5'
          ...
          >
            ...
            {isPendingDelete && (
              <div className="flex items-center justify-between gap-3 px-4 py-3 animate-fade-in">
      ...
      <Button size="sm" variant="secondary" onClick={onAdd} className="self-start mt-1" leftIcon={<PlusIcon />}>
        {addLabel}
      </Button>
    </div>
  )
